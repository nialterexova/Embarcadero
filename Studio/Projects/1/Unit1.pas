...
begin
     Label1.Caption:='Адрес папки: '+DirectoryListBox1.Directory;
end;
...
name:= DriveComboBox1.Drive ;
      ...
      label5.Caption:= IntToStr(DiskFree(dr))+' / '+IntToStr(DiskSize(dr))+'  байт';
end;
...
begin
    ...
    then begin
      label2.Caption:= 'Имя файла: '+searchresult.Name+' Размер: '+IntToStr(searchResult.Size);
      //+' Последнее изменение: '+IntToStr(searchResult.Time);
...
begin
Label3.Caption:='Адрес файла: '+FileListBox1.FileName;
end;
